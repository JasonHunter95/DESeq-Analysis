...
source("/Users/JasonHunter/Desktop/MouseData_Deseq/util/useful_functions.R")
...
my_peaks <- readRDS("/Users/JasonHunter/Desktop/MouseData_Deseq/ATACSeqData/my_peaks.rds")
...
![example of peak called by find_common_peaks in all samples.](../figures/common_peak_example.jpg)
...
![Example figure of a non-dox unique peak (not too convincing).](../figures/common_peak_example.jpg)
...
![example of peak unique to dox examples.](../figures/dox_specifc_example.jpg)
...
gencode_gr_mouse <- rtracklayer::import("/Users/JasonHunter/Desktop/MouseData_Deseq/ATACSeqData/gencode.vM25.annotation.gtf")
...
load("/Users/JasonHunter/Desktop/MouseData_Deseq/results/DESEQ_results.rdata")
...
![example of peak overlapping gene changing by RNAseq not to convincing again ....](../figures/RNAseq_atac_overlap.jpg)
...
# consensus peaks
broad_consensus_peaks <- read.table("/Users/JasonHunter/Desktop/MouseData_Deseq/ATACSeqData/consensus_peaks.mLb.clN.annotatePeaks.txt",
                             sep = "\t", header = TRUE)

# consensus peak counts
broad_consensus_counts <- read.table("/Users/JasonHunter/Desktop/MouseData_Deseq/ATACSeqData/consensus_peaks.mLb.clN.featureCounts.txt",
                             sep = "\t", header = TRUE)
...
```
![example of DESESEQ2 SIG ATAC PEAK top statistical](../figures/top_statistical_hit_deseq.jpg)
Result: Not very convincing

![example of DESESEQ2 SIG ATAC PEAK high base-mean](../figures/example_high_basemean_sig.jpg)
Result: Not very convincing
